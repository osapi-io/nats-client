...
The nats-client project has strict rules for AI usage:
...
These rules apply only to outside contributions to nats-client. Maintainers
...
Please remember that nats-client is maintained by humans.
...
nats-client is written with plenty of AI assistance, and many maintainers
